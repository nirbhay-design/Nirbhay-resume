...
<div class='head__title'> <span><strong>M.Tech</strong>, AI | Indian Institute of Science (IISc) Bangalore | AIR-6 GATE DA | CGPA: <strong>9.3</strong>/10 </span> <span class="duration">07/24-05/26</span> </div>

- Worked in **VAL Lab** and **ML Lab** at IISc under **Prof Venkatesh Babu** and **Prof Chiranjib Bhattacharyya**

<div class='head__title'> <span><strong>B.Tech</strong>, CSE | Indian Institute of Technology (IIT) Jodhpur | CGPA: <strong>8.97</strong>/10</span> <span class="duration">06/19-05/23</span> </div>

<div class='head__title'> <span><strong>Class $12^{th}$ </strong> | Dehradun public school | Percentage: <strong>96.4</strong> </span> <span class="duration">03/18-03/19</span> </div>

<div class='head__title'> <span><strong>Class $10^{th}$ </strong> | SD public school | CGPA: <strong>10/10</strong> </span> <span class="duration">03/16-03/17</span> </div>
...
Computer Vision (CV), Generative Adversarial Networks (GAN's), Natural Language Processing (NLP), Transformers, Federated Learning (FL), Self Supervised Representation Learning (SSL), Graph Neural Networks (GNNs)
...
<div class="head__title"><span> <strong> FedAgPD: Aggregation-Assisted Proxyless Distillation </strong> | IIT Jodhpur | <a href="https://ieeexplore.ieee.org/document/10650564"> Paper </a></span> <span class="duration"> 08/22-05/23 </span> </div>
...
<div class="head__title"><span> <strong> Extremely Lightweight CNN for Chest X-Ray Diagnosis </strong> | IIT Jodhpur | <a href="https://aapm.onlinelibrary.wiley.com/doi/abs/10.1002/mp.16722"> Paper </a> </span> <span class="duration"> 06/21-03/22 </span> </div>
...
<div class="head__title"><span> <strong> Cell Detection and Classification </strong> | IIT Jodhpur | </span> <span class="duration"> 08/22-03/23 </span> </div>
...
**Leveraging Generative Modelling for Self Supervised Learning** | [Github](https://github.com/nirbhay-design/ODE-SSL) | [Report](https://github.com/nirbhay-design/IISC_SEM3/blob/main/TVA/NirbhaySharma_24806_TVA_Final.pdf) | SSL, GenAI 
...
**Self Supervised Representation Learning Algorithms (SSL)** | [Github](https://github.com/nirbhay-design/RepresentationLearningAlgorithms) | SSL 
...
**Generative Models Implementation** | [Github](https://github.com/nirbhay-design/GenAImp) | Ongoing | Generative Models

- Implementing SOTA **generative** models like **score matching, Noise condition score networks, GANs, Flows** etc from scratch in pytorch
...
Stochastic Models and Applications (STOMA), Computational Methods of Optimization (CMO), Linear Algebra and Applications (LAA), Machine Learning for Signal Processing (MLSP), Natural Language Processing (NLP), Statistical Learning Theory (SLT), Concentration Inequalities, Dynamics of Linear System (DLS), Probability and Statistics, Optimization for Machine Learning (OML), Pattern Recognition and Machine Learning (PRML), Deep Learning, Dependable AI, Time Series Analysis, Cryptography, Blockchain, Computer Graphics

<!-- <h3> Statement of Purpose </h3>

--- 

My ultimate goal is to pursue doctoral research and be a part of research labs like Google DeepMind. I am highly interested and fascinated by the field of machine learning since bachelors. Reading, understanding and implementing SOTA research papers always fascinates me. I have implemented various papers from scratch like GANs, self supervised learning, federated learning, transformers etc. Apart from implementation, I also introduce my novel component into the algorithm like I implemented image captioning by tweking architecture of detection transformer, proposed novel methods for SSL to leverage generative modelling for representation learning and much more. Being part of this program helps me explore my research potential and elevate my research skills.
I have worked on research projects at IIT Jodhpur that resulted into publications in prestegious conference (IJCNN) and joural (Medical Physics). I am currently working under the guidance of prof. Venkatesh Babu at VAL lab on leveraging generative modelling for self supervised learning. I would love to work to the best of my potential on research projects at Google DeepMind.    -->
