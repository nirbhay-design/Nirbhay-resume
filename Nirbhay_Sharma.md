...
- Utilized **Pysyft** and **Jetson Nano** for transfering features from one device to another
...
- **Outperformed** the **relevent baselines** in terms of **test accuracy** by a considerable margin
